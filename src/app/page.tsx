...
export async function generateMetadata(): Promise<Metadata> {
  const formatName = getFormatName(CURRENT_FORMAT_ID);
...
export default async function HomePage() {
  const format_id = CURRENT_FORMAT_ID;
        ...
        <nav className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex space-x-6 text-sm">
              <Link href={`/vgc/${format_id}/cores/`} className="text-gray-300 hover:text-white transition-colors">
                Cores
              </Link>
              <Link href={`/vgc/${format_id}/counters/`} className="text-gray-300 hover:text-white transition-colors">
                Counters
              </Link>
              <Link href={`/vgc/${format_id}/archetypes/`} className="text-gray-300 hover:text-white transition-colors">
                Archetypes
              </Link>
            </div>
          </div>
